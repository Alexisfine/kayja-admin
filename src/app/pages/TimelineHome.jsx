...
import TimelineInsert from "./TimelineInsert"
import TimelineDelete from "./HonorDelete"
...
const TimelineHome = () => {
  const columns = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return <TimelineEdit info={data.find(i => i.id === id)} semaphore={setSemaphore}/>
      },
    },
    {
      accessorKey: "delete",
      ...
      cell: ({ row }) => {
        ...
        return <TimelineDelete info={row} semaphore={setSemaphore}/>
      },
    },
]
  ...
  return (
    <div className="w-full flex flex-col py-3 px-8">
      <h2 className='text-4xl'>公司时间线管理</h2>
      ...
      <div>
      <TimelineInsert title='新增' semaphore={setSemaphore} className='w-1/2'/>
      </div>
