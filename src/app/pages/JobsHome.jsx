...
const JobsHome = () => {
  const columns = [
  ...
  
    {
      ...
      cell: ({ row }) => {
        ...
        return <JobsUpdate info={data.find(i => i.id === id)} semaphore={setSemaphore}/>
      },
    },
    {
      accessorKey: "delete",
      ...
      cell: ({ row }) => {
        ...
        return <JobsDelete info={row} semaphore={setSemaphore}/>
      },
    },
]
  ...
  return (
    <div className="w-full flex flex-col py-3 px-8">
      <h2 className='text-4xl'>招聘职位管理</h2>
      ...
      <JobsInsert title='新增' semaphore={setSemaphore}/>
